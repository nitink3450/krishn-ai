...
const elements = [
  ...
  { name: "Fetching data with tailwind", link: "/project/tailwindPage" },
  { name: "Infinite scroll with SASS", link: "/project/infiniteScroll" },
    ...
    <div className="bg-black p-4">
      ...
      <ul className="list-none grid grid-cols-3">
        {elements.map((element, index) => (
          <li
            key={index}
            className="my-2 cardBg m-5 p-3 rounded-2xl hover:scale-105 hover:duration-500"
          >
